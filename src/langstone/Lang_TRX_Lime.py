...
class Lang_TRX_Lime(gr.top_block):
    ...
    def __init__(self):
        ...
        self.limesdr_source_0.set_sample_rate(528000)
        self.limesdr_source_0.set_center_freq(Rx_LO, 0)
        self.limesdr_source_0.set_bandwidth(2e6,0)
        self.limesdr_source_0.set_gain(Rx_Gain,0)
        self.limesdr_source_0.set_antenna(255,0)
        self.limesdr_source_0.calibrate(3e6, 0)

        self.limesdr_sink_0 = limesdr.sink('', 0, '', '')
        self.limesdr_sink_0.set_sample_rate(528000)
        self.limesdr_sink_0.set_center_freq(Tx_LO, 0)
        self.limesdr_sink_0.set_bandwidth(5e6,0)
        self.limesdr_sink_0.set_gain(Tx_Gain,0)
        self.limesdr_sink_0.set_antenna(255,0)
        self.limesdr_sink_0.calibrate(3e6, 0)
        ...
        self.audio_source_0 = audio.source(48000, "hw:"+sys.argv[2]+",0", False)
    ...
    def set_Tx_LO(self, Tx_LO):
        self.Tx_LO = Tx_LO
        self.limesdr_sink_0.set_center_freq(self.Tx_LO, 0)
    ...
    def set_Rx_LO(self, Rx_LO):
        self.Rx_LO = Rx_LO
        self.limesdr_source_0.set_center_freq(self.Rx_LO, 0)
